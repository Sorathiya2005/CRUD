...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Sorathiya\Python\Logical Programe\Django\CRM\crudenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Sorathiya\Python\Logical Programe\Django\CRM\crudenv\Scripts\deactivate.nu'
